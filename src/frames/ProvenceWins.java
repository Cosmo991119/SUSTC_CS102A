...
public class ProvenceWins extends JFrame {
    private JFrame frame;
    public ProvenceWins(JFrame frame){
        this.frame=frame;
        setLayout(null);

        ImageIcon amiyaw = new ImageIcon(AmiyaWins.basicLoad+"/pictuer/PWins.jpg");
